...
export class AboutComponent implements OnInit {
  ...
  // Quando vc cria uma variavel e não inicializa ou não é passada pelo construtor (ela fica sem valor), você colocar uma exclamação para dizer que pode ser vazia/nula.
  ...
  // private companyName: string = '854 & Co.'
